...
karmadapn.set_marking(Marking( Karmada_DuplicatedPP_Services=MultiSet([Service("Pod",minCPU=0.5,maxCPU=1)()]*10),
                        Karmada_Cluster1_Nodes=MultiSet([Node("node1",3,0.512)(),Node("node2",1,0.512)()]),
                        Karmada_Cluster2_Nodes=MultiSet([Node("node1",4,0.512)()]),
                        Karmada_Cluster3_Nodes=MultiSet([Node("node1",1,0.512)(),Node("node2",1,0.512)()])),                      
)
# ~~~~~~~~~~~~~~~ Testing~~~~~~~~~~~~~~~~~~~~~
