...
initial_marking= {
    "Karmada_Static_Weights_PP_Services":nets.MultiSet([("Weighted_Static",(Service("Pod",minCPU=0.2,maxCPU=1)(),(ObjectiveFunction(Service("Pod",minCPU=200,maxCPU=1000)()),[Node("node1",2000,1000)(),Node("node2",1000,1000)()]),1,3))]),
