...
karmadapn.set_marking(nets.Marking( Karmada_Aggregated_PP_Services=nets.MultiSet([("Aggregated",(Service("Pod",minCPU=0.5,maxCPU=1)(),14))]),
                        ...
                        Karmada_Aggregated_PP_C1_Resource_Modeling=nets.MultiSet([ResourceModelling(totalCPU=5,totalRAM=1.024)()]),
                        Karmada_Aggregated_PP_C2_Resource_Modeling=nets.MultiSet([ResourceModelling(totalCPU=1,totalRAM=0.512)()])
                        ),                      
)
# ~~~~~~~~~~~~~~~ Testing~~~~~~~~~~~~~~~~~~~~~
