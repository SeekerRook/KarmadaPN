...
karmadapn.set_marking(nets.Marking( Karmada_Static_Weights_PP_Services=nets.MultiSet([(Service("Pod",minCPU=0.5,maxCPU=1)(),12)]),
                        ...
                        Karmada_Static_Weights_PP_C1_Resource_Modeling=nets.MultiSet([(0,4,0,1.024,0,110)]),
                        Karmada_Static_Weights_PP_C2_Resource_Modeling=nets.MultiSet([(0,1,0,0.512,0,110)])
                        ),                      
)
# ~~~~~~~~~~~~~~~ Testing~~~~~~~~~~~~~~~~~~~~~
